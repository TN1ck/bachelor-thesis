    ...
    */
    {
        ...
        name: t.badges['login_1'].header, // the general name of the badge
        why: t.badges['login_1'].why,     // why did the user get the badge
        text: t.badges['login_1'].text,   // what the user needs to do, to get the badge
