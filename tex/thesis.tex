...
Als generische Anerkennung haben sich in der Welt der Gamification Trophäen und Bestenlisten etabliert da diese ohne viel Aufwand für die Entwickler einen großen Anreiz für die Benutzer liefern können.

In der Welt der Computerspiele sind diese besonders Wirksam, da eine hohe Punktzahl - und somit einer der besseren Plätze in der Bestenliste - mit rein objektiver Leistung zusammen hängt und offensichtlich zeigt: `Ich bin besser in diesem Spiel als alle unter mir'.
Auch sind Trophäen Objekte von hoher Prestige da einige nur mit sehr viel Arbeit und Geduld erlangt werden können.

Da keine der Aktionen in unserer Applikation technische Expertise verlangt und Punkte anhand von einfachen Aktionen sogar negativ sein könnte (Stellen Sie sich vor, Facebook würde eine Bestenliste ihrer Freunde machen anhand wer am längsten auf der Seite ist.) ist die Vergabe der Punkte leider nicht so trivial um Sie wirklich ansprechend zu machen.
