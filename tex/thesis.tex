...
\textit{Social Media Walls} sind eine Form der Darstellung für Inhalte mit kurzen Texten und Bildern aus verschiedenen sozialen Kanälen, die Besonderheit liegt in der Homogenisierung der Inhalte und die gleichzeitige Darstellung von verschiedenen Kanälen.
...
Diese Arbeit zielt darauf diese Frage zu beantworten und eine neue Visualisierungsform für Suchergebnisse zu finden mit der Inspiration von \textit{Social Medial Walls}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/infoboard_userstats.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/infoboard_flashmessage.png}
