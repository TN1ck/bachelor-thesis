...
\begin{description}
	...
	\item[cookies-js \cite{cookiesjs}] ist eine Bibliothek, die das Arbeiten mit \texttt{cookies} vereinfacht. \texttt{cookies} werden benutzt, um den Benutzer die automatische Authentifizierung mittels einem gespeicherten Token zu ermöglichen.
